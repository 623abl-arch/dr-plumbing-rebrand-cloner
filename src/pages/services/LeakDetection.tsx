  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        ...
        description="Advanced technology to find and fix hidden leaks before they cause damage. Non-invasive leak detection for water and gas lines. Call (727) 755-7000!"
      ...
      <section className="relative bg-gradient-hero text-primary-foreground py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Advanced Leak Detection</h1>
