...
const Largo = () => {
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        title="Largo Plumber | Dr. Plumbing Services | 24/7 Emergency"
        description="Expert plumbing services in Largo, FL. Available 24/7 for emergency repairs, drain cleaning, water heater service. Licensed & insured. Call (727) 755-7000."
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Plumbing Services in Largo</h1>
            </div>
            <p className="text-xl mb-8 text-primary-foreground/90">
              Your trusted local plumber serving Largo and surrounding areas. Available 24/7 for emergencies.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Largo Plumbing Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <ServiceCard
              ...
              description="24/7 emergency plumbing services for urgent issues in Largo."
              icon={Wrench}
          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            <h3 className="text-2xl font-bold mb-4">Why Choose Dr. Plumbing in Largo?</h3>
            <p className="text-muted-foreground mb-4">
              As a local, family-owned business, we understand the unique plumbing needs of Largo residents. 
            ...
            <p className="text-muted-foreground">
              ...
              we're here to help. Call us today at (727) 755-7000 for expert plumbing services in Largo.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Need a Plumber in Largo?</h2>
