  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEO 
        ...
        description="Trusted Belleair plumber for emergency repairs, drain cleaning & water heaters. Licensed, insured, 24/7 service. Your local experts. Call (727) 755-7000!"
        keywords="Belleair plumber, plumbing services Belleair FL, emergency plumber Belleair, drain cleaning Belleair"
        canonicalUrl="https://dr.plumbing/locations/belleair"
      />
      <Navbar />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h1 className="text-4xl md:text-5xl font-bold">Professional Plumber in Belleair, FL</h1>
            </div>
            <p className="text-xl mb-8 text-primary-foreground/90">
              Your trusted local plumber serving Belleair and surrounding areas. Available 24/7 for emergencies.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Our Belleair Plumbing Services</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <ServiceCard
              ...
              description="24/7 emergency plumbing services for urgent issues in Belleair."
              icon={Wrench}
          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            <h3 className="text-2xl font-bold mb-4">Why Choose Dr. Plumbing in Belleair?</h3>
            <p className="text-muted-foreground mb-4">
              As a local, family-owned business, we understand the unique plumbing needs of Belleair residents. 
            ...
            <p className="text-muted-foreground">
              ...
              we're here to help. Call us today at (727) 755-7000 for expert plumbing services in Belleair.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Need a Plumber in Belleair?</h2>
